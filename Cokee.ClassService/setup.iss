...
AppId={{E60511FD-C68F-425E-A06E-C824D241C9F7}
AppName={#MyAppName}
...
DefaultDirName={autopf}\CokeeClass
...
[Icons]
Name: "{autoprograms}\{#MyAppEName}"; Filename: "{app}\{#MyAppExeName}"
Name: "{autodesktop}\{#MyAppEName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon

[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppEName, '&', '&&')}}"; Flags: nowait postinstall skipifsilent
